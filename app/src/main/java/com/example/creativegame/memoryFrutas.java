...
public class memoryFrutas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_memory_frutas);
        cargarImagenes();
        botonesMenu();
        iniciar();
    ...
    public void Mostrar(View v){
        ...
        if(sp.contains("inf")){
            ...
            Intent i=new Intent(this,listaFrutas.class);
            ...
            if(numeroPrimero==numeroSegundo){//si coincide el valor los dejamos destapados
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        primero.setScaleType(ImageView.ScaleType.CENTER_CROP);
                        primero.setImageResource(R.drawable.fruta);
                        imgb.setScaleType(ImageView.ScaleType.CENTER_CROP);
                        imgb.setImageResource(R.drawable.fruta);
    ...
    public void Salir(View v){
        Intent i = new Intent(memoryFrutas.this, Menu.class);
        startActivity(i);
        finish();
