...
public class Tanagram extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tanagram);
        ...
        // SONIDOS
        sonidoTap = MediaPlayer.create(Tanagram.this, R.raw.ui_tap_variant_01);
        sonidoPiezaBien = MediaPlayer.create(Tanagram.this, R.raw.hero_simple_celebration_03);
        sonidoPiezaMal = MediaPlayer.create(Tanagram.this, R.raw.alert_error_01);
        sonidoFiguraBien = MediaPlayer.create(Tanagram.this, R.raw.hero_decorative_celebration_02);
        sonidoCambiaSiguiente = MediaPlayer.create(Tanagram.this, R.raw.navigation_forward_selection);
        ...
        ib_info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentInfo = new Intent(Tanagram.this, Info.class);
        ...
        tangramColores.setOnTouchListener (new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (!colocada){
                    ...
                    View.DragShadowBuilder piezaArrastrada = ImageDragShadowBuilder.fromBitmap(Tanagram.this, pieza);
            ...
            switch (action){
                ...
                case DragEvent.ACTION_DRAG_ENDED:
                    ...
                    if(colorViewClickada == colorViewSoltada){
                        ...
                        // SI ES CORRECTO...
                        Toast.makeText(Tanagram.this, "¡PIEZA COLOCADA CORRECTAMENTE!", Toast.LENGTH_SHORT).show();
                        ...
                        if (piezasColocadas == 7){
                            ...
                            figurasCompletadas++;
                            Toast.makeText(Tanagram.this, "¡GENIAL! ¡HAS COMPLETADO LA FIGURA!", Toast.LENGTH_LONG).show();
                        ...
                        puntuacion -= 10;
                        tv_puntuacion.setText(Integer.toString(puntuacion));
                        Toast.makeText(Tanagram.this, "ESE NO ES SU SITIO... ¡PRUEBA OTRA VEZ!", Toast.LENGTH_SHORT).show();
                    }
                    return true;
            }
            return false;
